namespace PostOfiice.DAta.Migrations
{
    ...
    public partial class reportFunction1_1 : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure(
                ...
                on s.GroupID = sg.ID
                where t.CreatedDate>=CAST(@fromDate as date) and t.CreatedDate<=cast(@toDate as date) and d.ID=@districtId 
                group by sg.Name, s.VAT");
        }

        public override void Down()
        {
            DropStoredProcedure("reportFunction1_1");
        }
    }
}
